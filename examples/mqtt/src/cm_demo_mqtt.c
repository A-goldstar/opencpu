...
/* 主题 */
static char *cmmqtt_glob_subtopic = "k0r3hJuDRee/ML307A/user/get";                         //用户自行写入订阅和发布主题
...
/* 服务器地址 */
static char cmqtt_glob_cfgserver[129] = "iot-06z009xprlynq0t.mqtt.iothub.aliyuncs.com";                     //用户自行写入MQTT测试服务器地址
...
/* client_id */
static char cmqtt_glob_cfgclient_id[129] = "k0r3hJuDRee.ML307A|securemode=2,signmethod=hmacsha256,timestamp=1744201557663|";                  //用户自行写入MQTT测试1号client_id

/* keepAlive参数 */
static int cmqtt_glob_cfgkeepAlive = 60;                        //用户自行修改连接保活时间

/* 用户名 */
static char cmqtt_glob_cfguser[129] = "ML307A&k0r3hJuDRee";                       //用户自行写入MQTT测试用户名      

/* 密码 */
static char cmqtt_glob_cfgpasswd[129] = "74676a99881ecb79a0e8d1b702b5629c141c7b55f50f437b7bf9987283f88c09";                     //用户自行写入MQTT测试1号密码
